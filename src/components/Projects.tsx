...
export default function Projects(){
    ...
    <div className="  w-full flex flex-col justify-center items-center">
      ...
      <div className=" relative z-10 grid grid-rows-4 md:grid-cols-2 md:grid-rows-2 gap-y-10 items-center justify-items-center">
        ...
        <ProjectCard src="/projects/billBuddies.jpeg"  github="https://github.com/Itaro18/bill-buddies" liveLink="https://bill-buddies.vercel.app" title=" Bill Buddies" description="built Bill Buddies, a Splitwise clone using Next.js, PostgreSQL, Prisma, and Tailwind, allowing users to effortlessly track group expenses and split bills. The app offers real-time syncing, a user-friendly interface," tags={["NextJS","Tailwind","Postgres"]}/>
