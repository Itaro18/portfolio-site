...
export default function Skills(){
    return <div className="relative w-full h-screen flex flex-col items-center bg-black bg-dot-white/[0.4]  px-12 border-dashed border-t-2 border-white mt-24">

        <h1 className="text-white text-7xl my-24"> Skills</h1>
        <div className="w-full  grid grid-cols-4 justify-items-center gap-12">
